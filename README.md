...
## 공유폴더 
https://drive.google.com/drive/u/0/folders/1FPPqaFBh4paxMyAWr3hk9f6Hktw3HX1j
...
|    |          |(캐글 & 이미지 분석  ) 공공 자전거 수요 예측 모형 만들기
|    |          |(블록체인)   인공지능을 위한 선형대수 - 4장 :  나머지 모두
|  4 |2018.10.26|(시각화)   Shiny4.pdf : Shiny module
|    |          |(캐글 & 이미지 분석  )  https://www.kaggle.com/kmader/siim-medical-images
|    |          |(블록체인)   인공지능을 위한 선형대수 - 5장 :  특이값 분해
